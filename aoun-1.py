...
if 'aarch64' in str(current_os):
    if not os.path.isfile('a64'):
        os.system('curl -L https://github.com/TALIBAN-188
/files/blob/main/hop/for_termux/aarch64/a64?raw=true > a64')
    ...
    if not os.path.isfile('a32'):
        os.system('curl -L https://github.com/TALIBAN-188/files/blob/main/hop/for_termux/arm/a32?raw=true > a32')
